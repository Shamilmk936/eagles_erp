                    ...
                    FFButtonWidget(
                      onPressed: () async {
                        ...
                        if(name.text!=''&&type!=''){
                          ...
                          if(proceed){
                            FirebaseFirestore.instance.collection('course').doc('C$courseNo').
                            set({
                              'name':name.text,
                              'courseType':type,
                            ...
                            doc.reference.update({
                              'courseNo':FieldValue.increment(1),
                            });
                          ...
                          name.text==''?showUploadMessage(context, 'Please Enter Name'):
                              showUploadMessage(context, 'please select a course type');
