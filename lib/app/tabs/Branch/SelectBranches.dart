...
class _BranchesWidgetState extends State<BranchesWidget> {
    ...
    FirebaseFirestore.instance.collection('branch')
        ...
        .listen((event) async {
          ...
          if(event.docs.length==1){
            ...
            localStorage.setString('email', event.docs.first['email']);
            ...
            currentbranchEmail=localStorage.getString('email');
  ...
  void initState() {
    ...
    print(currentUserUid+'*********************'+currentUserEmail);
                  ...
                  return Padding(
                    ...
                    child: InkWell(
                      onTap: () async {
                        ...
                        localStorage.setString('email', branch.docs.first['email']);
